  ...
  SCORE: [
    {
      id: '101',
      text: '夕暮れの港で帆船が虹を映す',
      reading: 'ゆうぐれのみなとではんせんがにじをうつす',
      romaji: 'yuugurenominatodehansenganijiwoutsusu',
      difficulty: 'SCORE',
      charCount: 18,
    },
    {
      id: '102',
      text: '朝霧の峡谷で川霧が静かに揺れる',
      reading: 'あさぎりのきょうこくでかわぎりがしずかにゆれる',
      romaji: 'asagirinokyoukokudekawagirishizukaniyureru',
      difficulty: 'SCORE',
      charCount: 20,
    },
    {
      id: '103',
      text: '星降る展望台で街灯りが遠く瞬く',
      reading: 'ほしふるてんぼうだいでまちあかりがとおくまたたく',
      romaji: 'hoshifurutenboudaidemachiakarigatookumatataku',
      difficulty: 'SCORE',
      charCount: 22,
    },
    {
      id: '104',
      text: '夏祭りの橋で太鼓が胸を震わせる',
      reading: 'なつまつりのはしでたいこがむねをふるわせる',
      romaji: 'natsumatsurinohashidetaikogamuneofuruwaseru',
      difficulty: 'SCORE',
      charCount: 20,
    },
    {
      id: '105',
      text: '朝露の竹林で小鳥が音色を紡ぐ',
      reading: 'あさつゆのちくりんでことりがねいろをつむぐ',
      romaji: 'asatsuyunochikurindekotoriganeirootsumugu',
      difficulty: 'SCORE',
      charCount: 19,
    },
  ],
